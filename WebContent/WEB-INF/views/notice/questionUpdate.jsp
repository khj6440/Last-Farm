...
<body>
	...
	<div class="community_body">
		...
		<div class="community_content">
			<br>
			<br>
			<h1 class="question_h1" style="font-weight: bold">자주 묻는 질문 수정</h1>
			<br>
			<form action="/questionUpdate" method="post" id="insertFrm">
				<table class="table table-bordered question_table">
					<input type="hidden" name="questionRef"
						value="${question.questionNo }">
					<tr>
						<th>제목</th>
						<td><input type="text" class="form-control"
							name="questionTitle" value="${question.questionTitle }"></td>
					</tr>
					...
					<tr style="text-align: center;">
						<th colspan="2">
							...
							<button type="reset" class="btn btn-outline-primary"
								onclick="location.href='/questionList?reqPage=1'">취소</button>
						</th>
					</tr>
				</table>
			</form>
	...
	<br>
	<jsp:include page="/WEB-INF/views/common/footer.jsp"></jsp:include> <script>
		$(function() {
