...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Gothic+A1&family=Noto+Serif+KR:wght@900&display=swap" rel="stylesheet">
    ...
    <div class="wrapped">
        <div class="title_notice">
            ...
            <div class="form_div">
                ...
                <form class="button_side f-right" action="/searchNotice" method="get">
                    ...
                    <button type="submit" class="btn btn-dark notice_search notice_search" onclick="return function1();">검색</button>
                </form>
            </div>
        </div>
                ...
                <tbody>
                    <c:forEach items="${list }" var="n">
                        <tr>
                            ...
                            <td class="table_title fnt1"><a class="notice_title fnt1" href="/noticeView?noticeNo=${n.noticeNo}">${n.noticeTitle }</a></td>
