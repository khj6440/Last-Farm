...
public class WarningService {
	...
	public int WarningInsert(int PageNo, int warningType, String warningWriter, int sellRef) {
	...
	public ArrayList<Warning> search4Warning(int sellComment) {
		Connection conn = JDBCTemplate.getConnection();
		ArrayList<Warning> list = new WarningDao().Search4Warning(conn,sellComment);
		JDBCTemplate.close(conn);
		return list;
	}
